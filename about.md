    ...
    <div class="about-content">
            ...
            <div class="background-content">
                <div class="degree-item">
                    <div class="degree-info">
                        <h3>Ph.D. in Computer Vision</h3>
                        <p class="institution">University of Genoa, Italy</p>
                        <p class="year">2022</p>
                        <p class="description">Dissertation: "Collaborative Learning in Computer Vision" - Focus on domain adaptation, continual learning, and ensemble methods for computer vision applications.</p>
                    </div>
                </div>
                <div class="degree-item">
                    <div class="degree-info">
                        <h3>M.S. in Computer Science</h3>
                        <p class="institution">Karachi Institute of Economics and Technology, Pakistan</p>
                        <p class="year">2015</p>
                        <p class="description">Thesis: "A multivariate data mining approach to predict match outcome in one-day international cricket" - Applied machine learning techniques to sports analytics.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="contact-section">
            ...
            <div class="contact-grid">
                ...
                <a href="{{ site.author.linkedin }}" target="_blank" class="contact-item linkedin">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="{{ site.author.scholar }}" target="_blank" class="contact-item scholar">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="{{ site.author.github }}" target="_blank" class="contact-item github">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
